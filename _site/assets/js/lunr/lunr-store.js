var store = [{
        "title": "Connect",
        "excerpt":" [Reference] https://codecademy.com 시작하기 목표:  우리는 Codecademy의 Python 교육 환경을 이용하여, 초보자도 Python 추가설치 없이 아주 쉽게 Python 문법을 배우는것을 목표로 합니다. ","categories": [],
        "tags": [],
        "url": "http://localhost:4000/codecademy/connect/",
        "teaser":null},{
        "title": "SingIn",
        "excerpt":"설명: [ 회원가입 ] 1단계 Codecademy 사이트로 이동합니다. 주소 : www.codecademy.com 설명: [ 회원가입 ] 2단계 Username 을 등록합니다. 설명: [ 회원가입 ] 3단계 Email 을 등록합니다. 설명: [ 회원가입 ] 4단계 Password 를 등록합니다. 설명: [ 회원가입 ] 5단계 Start coding now 를 눌러 등록을 완료합니다. 또는 지메일, 페이스북...","categories": [],
        "tags": [],
        "url": "http://localhost:4000/codecademy/signin/",
        "teaser":null},{
        "title": "LogIn",
        "excerpt":" 설명: [ 회원가입 ] 1단계  Username or Email 을 입력 합니다. 설명: [ 회원가입 ] 2단계  Password 를 입력 합니다. 설명: [ 회원가입 ] 3단계  Log in 을 누릅니다. ","categories": [],
        "tags": [],
        "url": "http://localhost:4000/codecademy/login/",
        "teaser":null},{
        "title": "Syllabus",
        ...
        "tags": [],
        "url": "http://localhost:4000/codecademy/syllabus/",
        "teaser":null},{
        "title": "Explain Screen",
        "excerpt":"[Main screen] Screen 화면은 크게 3개로 나뉘어 진다. 설명: [ ① 설명화면 ] • (Learn) 배워야 할 내용 • (Instruction) 실행할 미션 • (Hint) 미션을 도와줄 힌트 • (Forum) 포럼 • (Bug) 버그 송신 으로 구성되어 있다. 설명: [ ② 코딩화면(Editor) ] • 수행할 Instruction 을 작성(코딩)하는 곳이다. • Editor...","categories": [],
        "tags": [],
        "url": "http://localhost:4000/codecademy/explain-screen/",
        "teaser":null},{
        "title": "Learn",
        "excerpt":"    설명: [ Learn ] • 우리가 배워야 할 Python 문법을 설명 한다.  • 어떻게 Editor 화면에 Python 프로그램을 작성하는지를 설명하다. ","categories": [],
        "tags": [],
        "url": "http://localhost:4000/codecademy/learn/",
        "teaser":null},{
        "title": "Instructions",
        "excerpt":"    설명: [ Instruction ]  • 우리가 배운 Python 문법을 활용하여, 지시사항(Instruction)을 수행 한다.  • 예를 들면 지시문의 내용은 다음과 같다.  • e.g. print 문을 사용하여 출력 화면에 당신이 생각하는 문장을 출력하라.  ","categories": [],
        "tags": [],
        "url": "http://localhost:4000/codecademy/instructions/",
        "teaser":null},{
        "title": "Stuck? Get a hint",
        "excerpt":"     설명: [ Hint ] • 미션을 수행하기 어려운 경우 Hint를 참조한다.  • Stuck? get a hint 클릭  • Hint 참조 ","categories": [],
        "tags": [],
        "url": "http://localhost:4000/codecademy/stuck-get-a-hint/",
        "teaser":null},{
        "title": "Run and display Error",
        "excerpt":"  RUN &amp; Error 설명: [ Run ]  • Editor 화면에서 지시사항(Instruction)을 작성(coding)한 후,  • Run 버튼을 누른다.   • Display 화면에서 Error 또는 정상 메시지를 확인 한다. ","categories": [],
        "tags": [],
        "url": "http://localhost:4000/codecademy/run-error/",
        "teaser":null},{
        "title": "Solution",
        "excerpt":"Solution 설명: [ Solution ] • 여러차레 Run을 시도후에, 지시사항(Instruction)을 실패하면, Solution 버튼이 나타난다. 설명: [ Solution ] • Solution 버튼을 클릭하면, 수정된 Python 소스가 Editor 화면에 나타난다. • e.g. print “Hello “ + “Ishmael” 설명: [ Solution ] • Run 버튼을 다시 클릭하면, Display 화면에 정상적인 결과를 보여준다. »»...","categories": [],
        "tags": [],
        "url": "http://localhost:4000/codecademy/solution/",
        "teaser":null},{
        "title": "Community and Forums",
        "excerpt":"Here are some helpful links to the top questions asked by coders about this exercise: What is a block of code? What is an interpreted language? Is there any reason to use double or single quotes?Still have questions? View this exercise’s thread in the Codecademy Forums 설명: Codecademy를 사용하던중, 의문점이나...","categories": [],
        "tags": [],
        "url": "http://localhost:4000/codecademy/community-forums/",
        "teaser":null},{
        "title": "Report a bug",
        "excerpt":"        If you see a bug or any other issue with this page, please report it here. 설명:   • here 를 클릭하면, 설문 조사 화면이 나타난다.   • 자신의 의견을 선택하고, 남길 메시지를 적고 제출 하면 된다. ","categories": [],
        "tags": [],
        "url": "http://localhost:4000/codecademy/report-bug/",
        "teaser":null},{
        "title": "Python Syntax",
        ...
        "tags": [],
        "url": "http://localhost:4000/codecademy/python-syntax/",
        "teaser":null},{
        ...
        "tags": [],
        "url": "http://localhost:4000/codecademy/string-console-output/",
        "teaser":null},{
        "title": "Date and Time",
        ...
        "tags": [],
        "url": "http://localhost:4000/codecademy/date-and-time/",
        "teaser":null},{
        ...
        "tags": [],
        "url": "http://localhost:4000/codecademy/conditionals-control-flow/",
        "teaser":null},{
        "title": "PygLatin",
        ...
        "tags": [],
        "url": "http://localhost:4000/codecademy/pyglatin/",
        "teaser":null},{
        "title": "Functions",
        ...
        "tags": [],
        "url": "http://localhost:4000/codecademy/functions/",
        "teaser":null},{
        ...
        "tags": [],
        "url": "http://localhost:4000/codecademy/taking-vacation/",
        "teaser":null},{
        ...
        "tags": [],
        "url": "http://localhost:4000/codecademy/lists-dictionaries/",
        "teaser":null},{
        ...
        "tags": [],
        "url": "http://localhost:4000/codecademy/day-supermarket/",
        "teaser":null},{
        ...
        "tags": [],
        "url": "http://localhost:4000/codecademy/student-becomes-teacher/",
        "teaser":null},{
        ...
        "tags": [],
        "url": "http://localhost:4000/codecademy/lists-functions/",
        "teaser":null},{
        "title": "Battleship!",
        ...
        "tags": [],
        "url": "http://localhost:4000/codecademy/battleship/",
        "teaser":null},{
        "title": "Loops",
        ...
        "tags": [],
        "url": "http://localhost:4000/codecademy/loops/",
        "teaser":null},{
        ...
        "tags": [],
        "url": "http://localhost:4000/codecademy/practice-makes-perfect/",
        "teaser":null},{
        ...
        "tags": [],
        "url": "http://localhost:4000/codecademy/exam-statistics/",
        "teaser":null},{
        ...
        "tags": [],
        "url": "http://localhost:4000/codecademy/advanced-topics-python/",
        "teaser":null},{
        ...
        "tags": [],
        "url": "http://localhost:4000/codecademy/introduction-bitwise-operators/",
        "teaser":null},{
        "title": "String & Console Output",
        "excerpt":"PYTHON SYNTAX1. Strings 설명: [ Learn ] ① 설명: [ Instruction ] ① 설명: [ Hint ] 설명: [ Solution ] 결과 PYTHON SYNTAX2. 설명: [ Learn ] ① 설명: [ Instruction ] ① 설명: [ Hint ] 설명: [ Solution ] 결과 PYTHON SYNTAX3. 설명: [ Learn ] ①...","categories": [],
        "tags": [],
        "url": "http://localhost:4000/codecademy/--/",
        "teaser":null},{
        "title": "",
        "excerpt":"LESSON 설명: [ 학습방향 ] 이 장에서는 Python 을 활용한 다양한 자료구조를 학습한다. 딕셔너리, 리스트 등을 합칙, 분리하고, lambda 표현등을 학습한다. INTRODUCTION TO CLASSES1. Strings 설명: [ Learn ] 설명: [ Instruction ] 설명: [ Hint ] 설명: [ Solution ] 결과 INTRODUCTION TO CLASSES2. 설명: [ Learn ] 설명:...","categories": [],
        "tags": [],
        "url": "http://localhost:4000/codecademy/--/",
        "teaser":null},{
        "title": "",
        "excerpt":"PYTHON SYNTAX1. 설명: [ Learn ] ① 설명: [ Instruction ] ① 설명: [ Hint ] 설명: [ Solution ] 결과 PYTHON SYNTAX2. 설명: [ Learn ] ① 설명: [ Instruction ] ① 설명: [ Hint ] 설명: [ Solution ] 결과 PYTHON SYNTAX3. 설명: [ Learn ] ① 설명:...","categories": [],
        "tags": [],
        "url": "http://localhost:4000/codecademy/--/",
        "teaser":null},{
        ...
        "tags": [],
        "url": "http://localhost:4000/codecademy/introduction-classes/",
        "teaser":null},{
        "title": "Classes",
        ...
        "tags": [],
        "url": "http://localhost:4000/codecademy/classes/",
        "teaser":null},{
        ...
        "tags": [],
        "url": "http://localhost:4000/codecademy/file-input-output/",
        "teaser":null},{
        "title": "PYTHON FINAL PROJECT",
        "excerpt":"LESSON 설명: [ 학습방향 ]   Python 기초 작업을 모두 마쳤습니다.  ","categories": [],
        "tags": [],
        "url": "http://localhost:4000/codecademy/python-final-project/",
        "teaser":null},{
        "title": "String & Console Output",
        "excerpt":"PYTHON SYNTAX1. Strings 설명: [ ] ① 설명: [ ] ① 설명: [ ] 설명: [ ] 결과 PYTHON SYNTAX2. 설명: [ ] ① 설명: [ ] ① 설명: [ ] 설명: [ ] 결과 PYTHON SYNTAX3. 설명: [ ] ① 설명: [ ] ① 설명: [ ] 설명: [...","categories": [],
        "tags": [],
        "url": "http://localhost:4000/codecademy/--/",
        "teaser":null},{
        "title": "Syllabus",
        ...
        "tags": [],
        "url": "http://localhost:4000/codecademy/bk-syllabus/",
        "teaser":null},{
        "title": "Advanced Topics in Python",
        ...
        "tags": [],
        "url": "http://localhost:4000/codecademy/p3-python-syntax/",
        "teaser":null},{
        "title": "Syllabus (Python3)",
        "excerpt":"1. Python Syntax A. Python Syntax §2. Strings and Console Output A. String &amp; Console Output § B. Date and Time §3. Conditionals and Control Flow A. Conditionals &amp; Control Flow § B. PygLatin §4. Functions A. Functions § B. Taking a Vacation § 5. Lists &amp; Dictionaries A. Python...","categories": [],
        "tags": [],
        "url": "http://localhost:4000/codecademy/p3-syllabus/",
        "teaser":null},{
        "title": "Python Syntax",
        "excerpt":"LESSON This lesson will introduce you to Python 3, a general-purpose, object-oriented interpreted language you can use for countless standalone projects or scripting applications. 설명: [ 학습방향 ] 이 장에서는 객체 지향 프로그램 언어인 Python 3 을 소개합니다. Python은 수많은 독립형 프로젝트와 스크립트 응용 프로그램 환경에서 사용할 수 있습니다. PYTHON...","categories": [],
        "tags": [],
        "url": "http://localhost:4000/codecademy/p3-python-syntax/",
        "teaser":null},{
        "title": "String & Console Output",
        "excerpt":"LESSON This lesson will introduce you to strings and console output in Python, including creating string literals, calling a variety of string methods, and using the “print” keyword. 설명: [ 학습방향 ] 이 장에서는 문자열의 콘솔 출력, 생성, 함수 등 콘솔에 출력하는 방법을 학습한다. STRING &amp; CONSOLE OUTPUT1. Strings Another...","categories": [],
        "tags": [],
        "url": "http://localhost:4000/codecademy/p3-string-console-output/",
        "teaser":null},{
        "title": "Date and Time",
        "excerpt":"LESSON This lesson is a follow up to Unit 2: Strings and Console input and will give you practice with the concepts introduced in that lesson. 설명: [ 학습방향 ] 이 장에서는 2장의 연장선으로, 다양한 문자열을 콘솔에 출력하는 방법을 연습한다. DATA AND TIME1. The datetime Library A lot of times...","categories": [],
        "tags": [],
        "url": "http://localhost:4000/codecademy/p3-date-and-time/",
        "teaser":null},{
        "title": "Conditionals and Control Flow",
        "excerpt":"LESSON In this lesson, we’ll learn how to create programs that generate different outcomes based on user input! 설명: [ 학습방향 ] 이 장에서는 사용자의 의도에 따라 다른 결과 값을 생성하는 프로그램을 만드는 연습을 한다. CONDITIONALS &amp; CONTROL FLOW1. Go With the Flow Just like in real life, sometimes we’d...","categories": [],
        "tags": [],
        "url": "http://localhost:4000/codecademy/p3-conditionals-control-flow/",
        "teaser":null},{
        "title": "PygLatin",
        "excerpt":"LESSON In this lesson we’ll put together all of the Python skills we’ve learned so far including string manipulation and branching. We’ll be building a Pyg Latin translator. (That’s Pig Latin for Python Programmers!) 설명: [ 학습방향 ] 이 장에서는 지금까지 배운 것을 복습 해보자. PYGLATIN1. Break It Down Now...","categories": [],
        "tags": [],
        "url": "http://localhost:4000/codecademy/p3-pyglatin/",
        "teaser":null},{
        ...
        "tags": [],
        "url": "http://localhost:4000/codecademy/welcome-to-lls/",
        "teaser":null},{
        ...
        "tags": [],
        "url": "http://localhost:4000/codecademy/00-0-connect/",
        "teaser":null},{
        ...
        "tags": [],
        "url": "http://localhost:4000/codecademy/00-1-signin/",
        "teaser":null},{
        "title": "[Explain Screen] 기본 화면 설명 !!",
        "excerpt":"[#Python #Codecademy(코드카데미) #한글설명 가이드 #프로젝트 (00-#4)] [Main screen] Screen 화면은 크게 3개로 나뉘어 진다. 설명: [ ① 설명화면 ] • (Learn) 배워야 할 내용 • (Instruction) 실행할 미션 • (Hint) 미션을 도와줄 힌트 • (Forum) 포럼 • (Bug) 버그 송신 으로 구성되어 있다. 설명: [ ② 코딩화면(Editor) ] • 수행할...","categories": [],
        "tags": [],
        "url": "http://localhost:4000/codecademy/00-4-explain-screen/",
        "teaser":null},{
        ...
        "tags": [],
        "url": "http://localhost:4000/codecademy/00-5-learn/",
        "teaser":null},{
        ...
        "tags": [],
        "url": "http://localhost:4000/codecademy/00-6-0-instructions/",
        "teaser":null},{
        ...
        "tags": [],
        "url": "http://localhost:4000/codecademy/00-6-1-stuck-get-a-hint/",
        "teaser":null},{
        ...
        "tags": [],
        "url": "http://localhost:4000/codecademy/00-6-2-run-error/",
        "teaser":null},{
        "title": "[Solution] 정답 확인 방법!!",
        "excerpt":"[#Python #Codecademy(코드카데미) #한글설명 가이드 #프로젝트 (00-#6)] Solution 설명: [ Solution ] • 여러차레 Run을 시도후에, 지시사항(Instruction)을 실패하면, Solution 버튼이 나타난다. 설명: [ Solution ] • Solution 버튼을 클릭하면, 수정된 Python 소스가 Editor 화면에 나타난다. • e.g. print “Hello “ + “Ishmael” 설명: [ Solution ] • Run 버튼을 다시 클릭하면,...","categories": [],
        "tags": [],
        "url": "http://localhost:4000/codecademy/00-6-3-solution/",
        "teaser":null},{
        "title": "[Community and Forums] Python의 커뮤니티와 포럼에 참영하는 방법!!",
        "excerpt":"[#Python #Codecademy(코드카데미) #한글설명 가이드 #프로젝트 (00-#7)] Here are some helpful links to the top questions asked by coders about this exercise: What is a block of code? What is an interpreted language? Is there any reason to use double or single quotes?Still have questions? View this exercise’s thread in the...","categories": [],
        "tags": [],
        "url": "http://localhost:4000/codecademy/00-7-community-forum/",
        "teaser":null},{
        ...
        "tags": [],
        "url": "http://localhost:4000/codecademy/00-8-report-bug/",
        "teaser":null},{
        "title": "[Python Syntax] Python 기초 문법 설명 !!",
        "excerpt":"[#Python #Codecademy(코드카데미) #한글설명 가이드 #프로젝트 (01-#0)] LESSON This lesson will introduce you to Python, a general-purpose, object-oriented interpreted language you can use for countless standalone projects or scripting applications. 설명: [ 학습방향 ] 이 장에서는 객체 지향 프로그램 언어인 Python을 소개합니다. Python은 수많은 독립형 프로젝트와 스크립트 응용 프로그램 환경에서 사용할...","categories": [],
        "tags": [],
        "url": "http://localhost:4000/codecademy/01-0-python-syntax/",
        "teaser":null},{
        ...
        "tags": [],
        "url": "http://localhost:4000/codecademy/00-3-syllabus/",
        "teaser":null},{
        ...
        "tags": [],
        "url": "http://localhost:4000/codecademy/02-0-string-console-output/",
        "teaser":null},{
        ...
        "tags": [],
        "url": "http://localhost:4000/codecademy/02-1-date-and-time/",
        "teaser":null},{
        ...
        "tags": [],
        "url": "http://localhost:4000/codecademy/03-1-conditionals-control-flow/",
        "teaser":null},{
        ...
        "tags": [],
        "url": "http://localhost:4000/codecademy/03-2-pyglatin/",
        "teaser":null},]
