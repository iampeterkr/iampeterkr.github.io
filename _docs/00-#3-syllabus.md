...
*  A.	String & Console Output [§]({{site.baseurl}}/string-console-output/) [{{ site.baseurl }}/assets/images/codecademy/p2-eng.png){: width="100" height="100"}]({{site.baseurl}}/string-console-output/)
