...
*  A.	String & Console Output [§]({{site.baseurl}}/string-console-output/) [![p3-eng](https://iampeterkr.github.io/assets/images/codecademy/p3-eng.png){: width="110" height="110"}]({{site.baseurl}}/string-console-output/)[![p3-eng](https://iampeterkr.github.io/assets/images/codecademy/p2-eng.png){: width="110" height="110"}]({{site.baseurl}}/string-console-output/) 
